          ...
          <div class="top">
            <div class="section">
              ...
              <div class="button-container">
                <button @click="toggleRecording">{{ isRecording ? '停止录制' : '开始录课' }}</button>
                <button @click="uploadRecording">发布课程</button>
              </div>
            </div>
            <div class="section">
              <h2>本地课程</h2>
              <div class="button-container">
                ...
                <button @click="startUploading">开始上传</button>
                <button @click="uploadLocalCourse">发布课程</button>
              </div>
            </div>
          </div>
          <div class="bottom">
            <h2>课程概述</h2>
            <div class="button-container">
              <button @click="generateAIDescription">AI概述</button>
              <button @click="startManualEdit">手动修改</button>
              <button @click="startManualEdit">提交概述</button>
            </div>
